  ...
  return (
    <section className="h-full  p-2">
      <div>
        ...
        />
        <button className="w-32 border border-gray-300 rounded-md ml-[314px] h-8" onClick={()=>{setAddingItem(true)}}>
          Add project
        </button>
        <button className="w-32 border border-gray-300 rounded-md ml-2 h-8">
          Actions
        </button>
        <button className="w-32 border border-gray-300 rounded-md ml-2 h-8">
          Filter
          ...
          {items.map((item) => (
            <tr key={item.id} className="border-b border-gray-300">
              ...
              <td className="border border-gray-300 p-2">
                <button className="text-blue-500" onClick={() => handleEdit(item)}>Edit</button>
      ...
      {editingItem && addItems (
        <form onSubmit={handleSubmit} className="mt-4">
          ...
          <input
            ...
            className="border border-gray-300 rounded-md p-2 mr-2"
          />
          <button type="submit" className="bg-blue-500 text-white rounded-md p-2">Update</button>
        </form>
      )}

      {
        ...
        <input
          ...
          required
        />
        <button type="submit" className="h-8 border border-gray-300 rounded-md ml-2">
          Add Item
        </button>
      </form>
        )
      ...
      <div className="w-full h-10 border border-gray-300 flex items-center justify-end">
        <button className="w-10 border border-gray-300 rounded-md mx-1 h-8">10</button>
        <button className="w-10 border border-gray-300 rounded-md mx-1 h-8">20</button>
        <button className="w-10 border border-gray-300 rounded-md mx-1 h-8">...</button>
        <button className="w-10 border border-gray-300 rounded-md mx-1 h-8">50</button>
      </div>
    </section>
  );
};
